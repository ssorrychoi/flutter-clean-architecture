...
import 'package:practice_clean_architecture/util/date_parse.dart';
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Obx(
                          () => Row(
                            children: [
                              Text(screenViewModel.versionInfo.name ?? 'VERSION'),
                              const Spacer(),
                              Text(
                                screenViewModel.versionInfo.version ?? '03.',
                              ),
                            ],
                          ),
                        ),
                                        ...
                                        return Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Text(dateToString(longWeekend.startDate)),
                                                  Text(' ~ '),
                                                  Text(dateToString(longWeekend.endDate)),
                                                ],
                                              ),
